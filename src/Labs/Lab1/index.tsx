  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: potatoes
        <ol id="wd-your-favorite-recipe">
          <li>Cut the potatoes in halves or quarters.</li>
          <li>
            Mix them in a bowl with olive oil, salt, pepper, and garlic powder.
          </li>
          <li>
            Put them in the air fryer at 400 degrees for 15 minutes. Flip
            halfway through.
          </li>
        </ol>
      ...
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <input
            type="number"
            value="100000" //doesn't let me increment/change but when i comment it out it does.
            placeholder="1000"
          ...
          <input
            type="range"
            // value="4" //comenting out so i can manipulate the data
            max="5"
            placeholder="Doe"
          ...
          <input
            type="date"
            // value="2000-01-21" //commenting out again
